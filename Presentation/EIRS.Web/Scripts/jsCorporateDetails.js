...
function jsfn_FilterAssessmentRuleTable(vTaxYear) {
  vAssessmentRuleTable.fnFilter(vTaxYear, 0, false, false, false, false);
}
...
function jsfn_FilterMDAServiceTable(vTaxYear) {
  vMDAServiceTable.fnFilter(vTaxYear, 0, false, false, false, false);
}
...
function jsfn_ChangeStatus(compId) {
  var vData = {
    CompanyID: compId,
  };
  jsfn_ShowLoading();
  jsfn_ajaxPost(
    "/CaptureCorporate/UpdateStatus",
    vData,
...
function jsfn_ChangeAssetLinkStatus(tpaid, tpid, tptid) {
  ...
  jsfn_ShowLoading();
  jsfn_ajaxPost(
    "/CaptureCorporate/UpdateAssetStatus",
    vData,
