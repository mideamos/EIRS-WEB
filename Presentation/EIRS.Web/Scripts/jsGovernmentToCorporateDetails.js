...
function jsfn_DisplayDataResponse(data) {
    if (data.success == true) {
        ...
        $('#txtTaxPayerName').html($('#CompanyName').val());
        $('#txtTIN').html($('#TIN').val());
        $('#txtTaxPayerType').html("Company");
        $('#txtMobileNumber1').html($('#MobileNumber1').val());
        $('#txtMobileNumber2').html($('#MobileNumber2').val());
        $('#txtEmail1').html($('#EmailAddress1').val());
        $('#txtEmail2').html($('#EmailAddress2').val());
        $('#txtTaxPayerRin').html($('#CompanyRIN').val());
...
function jsfn_bindTable() {
    ...
    var vSortOrder = [];
    jsfn_ConvertToDatableWithCustomSort($('#tblAssetListDisplay'), vColumnList, 'No Assets Found', vSortOrder);
    $('.collapse').click();
}
