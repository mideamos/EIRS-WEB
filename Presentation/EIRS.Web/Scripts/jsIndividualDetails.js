...
$(document).ready(function () {
  vAssetTable = jsfn_ConvertToDatableWithCustomSort(
    $("#tblAssetList"),
    [
      { orderable: true },
      { orderable: true },
    ...
    "No Assoicated Assets Found"
  );
  vAssessmentRuleTable = jsfn_ConvertToDatableWithCustomSort(
    $("#tblAssessmentRules"),
    [
      { orderable: true },
      { orderable: true },
    ...
    "No Assoicated Rules Found"
  );
  jsfn_ConvertToDatableWithCustomSort(
    $("#tblProfileList"),
    [
      { orderable: true },
      { orderable: true },
  ...
  jsfn_ConvertToDatableWithCustomSort(
    ...
    "No Declined Approvals Found"
  );
  vMDAServiceTable = jsfn_ConvertToDatableWithCustomSort(
    $("#tblMDAServiceList"),
    [
      { orderable: true },
      { orderable: true },
    ...
    "No Assoicated MDA Services Found"
  );
  vBillTable = jsfn_ConvertToDatableWithCustomSort(
    $("#tblBillList"),
    [
      { orderable: true },
      { orderable: true },
    ...
    "No Assoicated Bills Found"
  );
  vPaymentTable = jsfn_ConvertToDatableWithCustomSort(
    $("#tblPaymentList"),
    [
      { orderable: true },
      { orderable: true },
  ...
  $("#btnSaveRequest").click(function () {
    ...
    if (vTaxYear !== "") {
      ...
      jsfn_ShowLoading();
      jsfn_ajaxPost(
        "/CaptureIndividual/AddTCCRequest",
        vData,
        jsfn_AddTCCResponse
      );
    } else {
      $("#dvTCCRMessage").html(
        '<div class="alert alert-danger">Select Tax Year</div>'
      );
    }
  });
});
...
function jsfn_AssessmentRuleDetails(aruleID) {
  ...
  jsfn_ShowLoading();
  jsfn_ajaxPost(
    "/Base/GetAssessmentRuleDetails",
    vData,
    jsfn_ShowAssessmentRuleDetailResponse
  );
}
function jsfn_ShowAssessmentRuleDetailResponse(data) {
  ...
  if (data.success) {
    ...
    $("#dvAssessmentRuleRefNo").html(
      data.AssessmentRuleDetails.AssessmentRuleCode
    );
    $("#dvAssessmentRuleName").html(
      data.AssessmentRuleDetails.AssessmentRuleName
    );
    ...
    $("#dvSettlementMethod").html(
      data.AssessmentRuleDetails.SettlementMethodNames
    );
...
function jsfn_AssessmentRuleItemList(aruleID) {
  ...
  jsfn_ShowLoading();
  jsfn_ajaxPost(
    "/Base/GetAssessmentRuleItemList",
    vData,
    jsfn_AssessmentRuleItemResponse
  );
}
...
function jsfn_AssessmentRuleItemResponse(data) {
  ...
  if (data.success) {
    ...
    jsfn_ConvertToDatableWithCustomSort(
      $("#tblAssessmentRuleItem"),
      [{ orderable: true }, { orderable: true }, { orderable: true }],
...
function jsfn_ProfileDetails(prfID) {
  ...
  jsfn_ShowLoading();
  jsfn_ajaxPost(
    "/Base/GetProfileDetails",
    vData,
    jsfn_ShowProfileDetailResponse
  );
}
...
function jsfn_ShowProfileDetailResponse(data) {
  ...
  if (data.success) {
    ...
    $("#dvSectorSubElement").html(
      data.ProfileDetails.ProfileSectorSubElementNames
    );
    $("#dvProfileAttribute").html(data.ProfileDetails.ProfileAttributeNames);
    $("#dvProfileSubAttribute").html(
      data.ProfileDetails.ProfileSubAttributeNames
    );
  } else {
    jsfn_ShowAlert(data.Message, "danger");
  }
...
function jsfn_MDAServiceDetails(MDAServiceID) {
  ...
  jsfn_ShowLoading();
  jsfn_ajaxPost(
    "/Base/GetMDAServiceDetails",
    vData,
    jsfn_MDAServiceDetailResponse
  );
}
...
function jsfn_MDAServiceDetailResponse(data) {
  ...
  if (data.success) {
    ...
    $("#dvMDASettlementMethod").html(
      data.MDAServiceDetails.SettlementMethodNames
    );
...
function jsfn_MDAServiceItemList(MDAServiceID) {
  ...
  jsfn_ShowLoading();
  jsfn_ajaxPost(
    "/Base/GetMDAServiceItemList",
    vData,
    jsfn_MDAServiceItemResponse
  );
}
...
function jsfn_BillDetails(billid, billtype) {
  if (billtype === 1) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost(
      "/Base/GetAssessmentDetails",
      vData,
      jsfn_AssessmentDetailResponse
    );
  } else if (billtype === 2) {
    var vData = {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost(
      "/Base/GetServiceBillDetails",
      vData,
      jsfn_ServiceBillDetailResponse
    );
  }
}
...
function jsfn_AssessmentDetailResponse(data) {
  ...
  if (data.success) {
    ...
    $("#dvAssessmentDate").html(
      jsfn_FormatJsonDate(data.AssessmentDetails.AssessmentDate)
    );
    $("#dvATaxPayerTypeName").html(data.AssessmentDetails.TaxPayerTypeName);
    $("#dvATaxPayerName").html(data.AssessmentDetails.TaxPayerName);
    $("#dvAssessmentAmount").html(
      data.AssessmentDetails.AssessmentAmount.formatMoney(2, "₦")
    );
    $("#dvASettlementDueDate").html(
      jsfn_FormatJsonDate(data.AssessmentDetails.SettlementDueDate)
    );
    $("#dvASettlementStatus").html(data.AssessmentDetails.SettlementStatusName);
    $("#dvASettlementDate").html(
      data.AssessmentDetails.SettlementDate != null
        ? jsfn_FormatJsonDate(data.AssessmentDetails.SettlementDate)
        : "-"
    );
...
function jsfn_ServiceBillDetailResponse(data) {
  ...
  if (data.success) {
    ...
    $("#dvServiceBillDate").html(
      jsfn_FormatJsonDate(data.ServiceBillDetails.ServiceBillDate)
    );
    ...
    $("#dvServiceBillAmount").html(
      data.ServiceBillDetails.ServiceBillAmount.formatMoney(2, "₦")
    );
    $("#dvSSettlementDueDate").html(
      jsfn_FormatJsonDate(data.ServiceBillDetails.SettlementDueDate)
    );
    $("#dvSSettlementStatus").html(
      data.ServiceBillDetails.SettlementStatusName
    );
    $("#dvSSettlementDate").html(
      data.ServiceBillDetails.SettlementDate != null
        ? jsfn_FormatJsonDate(data.ServiceBillDetails.SettlementDate)
        : "-"
    );
...
function jsfn_BillPaymentDetails(billid, billtype) {
  ...
  jsfn_ShowLoading();
  jsfn_ajaxPost(
    "/Base/GetBillPaymentList",
    vData,
    jsfn_BillPaymentDetailResponse
  );
}
...
function jsfn_PaymentDetails(paymentid, paymenttype) {
  if (paymenttype === 1) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost(
      "/Base/GetSettlementDetails",
      vData,
      jsfn_SettlementDetailResponse
    );
    ...
    jsfn_ajaxPost(
      "/Base/GetPoADetails",
      vData,
      jsfn_PaymentAccountDetailResponse
    );
...
function jsfn_PaymentAccountDetailResponse(data) {
  ...
  if (data.success) {
    ...
    $("#dvPaymentAccountDate").html(
      jsfn_FormatJsonDate(data.PaymentAccountDetails.PaymentDate)
    );
    $("#dvPATaxPayerTypeName").html(
      data.PaymentAccountDetails.TaxPayerTypeName
    );
    $("#dvPATaxPayerRIN").html(data.PaymentAccountDetails.TaxPayerRIN);
    $("#dvPATaxPayerName").html(data.PaymentAccountDetails.TaxPayerName);
    $("#dvPaymentAccountAmount").html(
      data.PaymentAccountDetails.Amount.formatMoney(2, "₦")
    );
    $("#dvPATransactionReferenceNo").html(
      data.PaymentAccountDetails.TransactionReferenceNo
    );
    $("#dvRevenueStreamName").html(
      data.PaymentAccountDetails.RevenueStreamName
    );
...
function jsfn_SettlementDetailResponse(data) {
  ...
  if (data.success) {
    ...
    $("#dvSettlementDate").html(
      jsfn_FormatJsonDate(data.SettlementDetails.SettlementDate)
    );
    ...
    $("#dvSettlementAmount").html(
      data.SettlementDetails.SettlementAmount.formatMoney(2, "₦")
    );
    $("#dvASBRefNo").html(data.SettlementDetails.ASRefNo);
    $("#dvTransactionReferenceNo").html(
      data.SettlementDetails.TransactionReferenceNo
    );
...
function jsfn_ChangeStatus(Individualid) {
  ...
  jsfn_ShowLoading();
  jsfn_ajaxPost(
    "/CaptureIndividual/UpdateStatus",
    vData,
    jsfn_ChangeStatusResponse
  );
}
...
function jsfn_ChangeAssetLinkStatus(tpaid, tpid, tptid) {
  ...
  jsfn_ShowLoading();
  jsfn_ajaxPost(
    "/CaptureIndividual/UpdateAssetStatus",
    vData,
    jsfn_ChangeAssetLinkStatusResponse
  );
}
