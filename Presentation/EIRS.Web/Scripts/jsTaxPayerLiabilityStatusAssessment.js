...
function jsfn_bindTable() {
    vTaxPayerLiabilityStatusDataTable = $("#tblTaxPayerLiabilityStatusDetails").DataTable({
        ...
        "ajax": {
            "url": "/OperationManager/TaxPayerLiabilityStatusAssessmentLoadData",
            "type": "POST",
            "datatype": "json",
            "data": function (data) {
        ...
        "columns": [
            ...
            { "data": "BillRefNo", "orderable": true, "name": "BillRefNo", "width": "25%" },
            {
                "data": "BillDate", "orderable": true, "name": "BillDate", "width": "25%", "render": function (data, type, st) {
                    return jsfn_FormatJsonDate(st.BillDate);
                }
            ...
            { "data": "SettlementStatusName", "orderable": true, "name": "SettlementStatusName", "width": "25%" },
            {
