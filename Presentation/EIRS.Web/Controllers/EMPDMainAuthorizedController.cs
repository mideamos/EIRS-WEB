...
{
    public class EMPDMainAuthorizedController : BaseController
    {
        // GET: EMPDMainAuthorized
        [HttpGet]
        ...
        public ActionResult ImportData(EMDataImportViewModel pObjDataImportModel)
        {
            ...
            else
            {
                if (pObjDataImportModel.ExcelFile.ContentLength > 0)
                {
                    ...
                    {
                        string strInputFileName = "PDMainAuthorizedData_" + DateTime.Now.ToString("dd_MM_yyyy") + "_" + DateTime.Now.Hour + "_" + DateTime.Now.Minute + "_" + DateTime.Now.Second + "." + strUploadedFileExt;
                        string strOutputFileName = "PDMainAuthorizedResult_" + DateTime.Now.ToString("dd_MM_yyyy") + "_" + DateTime.Now.Hour + "_" + DateTime.Now.Minute + "_" + DateTime.Now.Second + "." + strUploadedFileExt;
                        string fileLocation = GlobalDefaultValues.DocumentLocation + "ERASManual/PDMA/";
                        ...
                        using (ExcelPackage mObjExcelPackage = new ExcelPackage(new FileInfo(fileLocation + "/" + strInputFileName)))
                        {
                            if (mObjExcelPackage.Workbook.Worksheets.Count == 1)
                            {
                                ...
                                if (dtExcelData.Rows.Count > 0)
                                {
                                    ...
                                    EM_PD_Main_Authorized mObjMainAuthorized;
                                    ...
                                    foreach (DataRow drData in dtExcelData.Rows)
                                    {
                                        try
                                        {
                                            ...
                                            mObjMainAuthorized = new EM_PD_Main_Authorized()
                                            {
                                                PDMAID = 0,
                                            ...
                                            mObjFuncResponse = mObjBLEMDataImport.BL_InsertPDMainAuthorized(mObjMainAuthorized);
                        ...
                        {
                            ExcelWorksheet ObjExcelWorksheet = mObjExcelPackage.Workbook.Worksheets.Add("PDMainAuthorized");
                            ...
                            ViewBag.ResultFilePath = "/Document/ERASManual/PDMA/" + strOutputFileName;
                            return View();
        ...
        public ActionResult AddEntry(EMPDViewModel pObjEMPDModel)
        {
            ...
            else
            {
                try
                {
                    EM_PD_Main_Authorized mObjMainAuthorized = new EM_PD_Main_Authorized()
                    {
                        PDMAID = 0,
                    ...
                    FuncResponse mObjFuncResponse = new BLEMDataImport().BL_InsertPDMainAuthorized(mObjMainAuthorized);
        ...
        public JsonResult LoadData()
        {
            ...
            try
            {
                ...
                // Loading. 
                IList<vw_EM_PD_Main_Authorized> lstData = new BLEMDataImport().BL_GetPDMainAuthorizedList();
        ...
        public ActionResult Details(long? id)
        {
            ...
            {
                EM_PD_Main_Authorized mObjDetails = new BLEMDataImport().BL_GetPDMainAuthorizedDetails(id.GetValueOrDefault());
                ...
                {
                    return RedirectToAction("List", "EMPDMainAuthorized");
                }
            }
            else
            {
