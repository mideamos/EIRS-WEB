    ...
    $('#dvRemoveDialog').dialog({
        ...
        buttons: [{
            ...
            click: function () {
                var vData = {
                    IAIID: $("#hdnTBID").val(),
                    IndividualID: $("#hdnOtherID").val()
                };

                jsfn_ShowLoading();
                jsfn_ajaxPost('/Individual/RemoveAddressInformation', vData, jsfn_RemoveAddressResponse);
            }
        }, {
...
function jsfn_ShowDetails(bldid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/Individual/GetAddressInformationDetails', vData, jsfn_AddressDetailResponse);
}
...
function jsfn_RemoveAddress(iaiid, taxpayerid) {
