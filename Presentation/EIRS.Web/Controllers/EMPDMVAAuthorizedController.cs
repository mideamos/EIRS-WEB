...
{
    public class EMPDMVAAuthorizedController : BaseController
    {
        // GET: EMPDMVAAuthorized
        [HttpGet]
        ...
        public ActionResult ImportData(EMDataImportViewModel pObjDataImportModel)
        {
            ...
            else
            {
                if (pObjDataImportModel.ExcelFile.ContentLength > 0)
                {
                    ...
                    {
                        string strInputFileName = "PDMVAAuthorizedData_" + DateTime.Now.ToString("dd_MM_yyyy") + "_" + DateTime.Now.Hour + "_" + DateTime.Now.Minute + "_" + DateTime.Now.Second + "." + strUploadedFileExt;
                        string strOutputFileName = "PDMVAAuthorizedResult_" + DateTime.Now.ToString("dd_MM_yyyy") + "_" + DateTime.Now.Hour + "_" + DateTime.Now.Minute + "_" + DateTime.Now.Second + "." + strUploadedFileExt;
                        string fileLocation = GlobalDefaultValues.DocumentLocation + "ERASManual/PDMVAA/";
                        ...
                        using (ExcelPackage mObjExcelPackage = new ExcelPackage(new FileInfo(fileLocation + "/" + strInputFileName)))
                        {
                            if (mObjExcelPackage.Workbook.Worksheets.Count == 1)
                            {
                                ...
                                if (dtExcelData.Rows.Count > 0)
                                {
                                    ...
                                    EM_PD_MVA_Authorized mObjMVAAuthorized;
                                    ...
                                    foreach (DataRow drData in dtExcelData.Rows)
                                    {
                                        try
                                        {
                                            ...
                                            mObjMVAAuthorized = new EM_PD_MVA_Authorized()
                                            {
                                                PDMVAID = 0,
                                            ...
                                            mObjFuncResponse = mObjBLEMDataImport.BL_InsertPDMVAAuthorized(mObjMVAAuthorized);
                                    ...
                                    EM_ImportLog mObjImportLog = new EM_ImportLog()
                                    {
                                        ...
                                        ImportFilePath = "ERASManual/PDMVAA/" + strInputFileName,
                        ...
                        {
                            ExcelWorksheet ObjExcelWorksheet = mObjExcelPackage.Workbook.Worksheets.Add("PDMVAAuthorized");
                            ...
                            ViewBag.ResultFilePath = "/Document/ERASManual/PDMVAA/" + strOutputFileName;
                            return View();
        ...
        public ActionResult AddEntry(EMPDViewModel pObjEMPDModel)
        {
            ...
            else
            {
                try
                {
                    EM_PD_MVA_Authorized mObjMVAAuthorized = new EM_PD_MVA_Authorized()
                    {
                        PDMVAID = 0,
                    ...
                    FuncResponse mObjFuncResponse = new BLEMDataImport().BL_InsertPDMVAAuthorized(mObjMVAAuthorized);
        ...
        public JsonResult LoadData()
        {
            ...
            try
            {
                ...
                // Loading. 
                IList<vw_EM_PD_MVA_Authorized> lstData = new BLEMDataImport().BL_GetPDMVAAuthorizedList();
        ...
        public ActionResult Details(long? id)
        {
            ...
            {
                EM_PD_MVA_Authorized mObjDetails = new BLEMDataImport().BL_GetPDMVAAuthorizedDetails(id.GetValueOrDefault());
                ...
                {
                    return RedirectToAction("List", "EMPDMVAAuthorized");
                }
            }
            else
            {
