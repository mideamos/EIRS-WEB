$(document).ready(function () {
    ...
    $("#btnSaveLinkAsset").click(function () {
        ...
        if (vTaxPayerRoleID !== '' && ((vBuildingUnitID !== '' && $("#hdnAssetTypeID").val() === '1') || $("#hdnAssetTypeID").val() !== '1')) {
            ...
            jsfn_ShowLoading();
            jsfn_ajaxPost('/SignupIndividual/LinkAsset', vData, jsfn_LinkAssetResponse);
        }
        else {
...
function jsfn_LinkAssetResponse(data) {
    ...
    if (data.success) {
        ...
        window.location.href = '/SignupIndividual/GeneratePassword';
    }
    else {
...
function jsfn_BuildingDetails(bldid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/SignupIndividual/GetBuildingDetails', vData, jsfn_BuildingDetailResponse);
}
...
function jsfn_BusinessDetails(busid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/SignupIndividual/GetBusinessDetails', vData, jsfn_BusinessDetailResponse);
}
...
function jsfn_LandDetails(lndid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/SignupIndividual/GetLandDetails', vData, jsfn_LandDetailResponse);
}
...
function jsfn_VehicleDetails(vchid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/SignupIndividual/GetVehicleDetails', vData, jsfn_VehicleDetailResponse);
}
...
function jsfn_LinkBuilding(bldid) {
    ...
    jsfn_ajaxPost('/SignupIndividual/GetTaxPayerRoleAssetBased', vData, jsfn_BindTaxPayerRoleResponse);
    jsfn_ajaxPost('/SignupIndividual/GetBuildingUnitList', { BuildingID: bldid }, jsfn_BindBuildingUnitResponse);
}
