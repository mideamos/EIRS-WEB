...
function jsfn_ChangeStatus(Governmentid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/CaptureGovernment/UpdateStatus', vData, jsfn_ChangeStatusResponse);
}
...
function jsfn_ChangeAssetLinkStatus(tpaid, tpid, tptid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/CaptureGovernment/UpdateAssetStatus', vData, jsfn_ChangeAssetLinkStatusResponse);
}
