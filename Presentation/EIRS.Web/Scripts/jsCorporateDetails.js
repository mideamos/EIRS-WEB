...
function jsfn_ChangeStatus(compId) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/CaptureCorporate/UpdateStatus', vData, jsfn_ChangeStatusResponse);
}
...
function jsfn_ChangeAssetLinkStatus(tpaid, tpid, tptid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/CaptureCorporate/UpdateAssetStatus', vData, jsfn_ChangeAssetLinkStatusResponse);
}
