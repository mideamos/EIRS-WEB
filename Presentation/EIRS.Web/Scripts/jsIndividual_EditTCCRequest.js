...
$(document).ready(function () {
    ...
    $("#btSaveIncomeStream").click(function (e) {
        if (vfrmAddIncomeStream.valid()) {
            ...
            jsfn_ShowLoading();
            jsfn_ajaxPost('/CaptureIndividual/AddIncomeStream', vData, jsfn_onAddIncomeStreamResponse);
        }
    });
...
function jsfn_DeleteIncomeStream(RowID) {
    ...
    jsfn_ajaxPost('/CaptureIndividual/DeleteIncomeStream', vData, jsfn_DeleteIncomeStreamResponse);
}
