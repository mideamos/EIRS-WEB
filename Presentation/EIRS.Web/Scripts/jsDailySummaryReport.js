$(document).ready(function () {
    ...
    var frmDailySummary = $('#frmDailySummary');

    frmDailySummary.validate({
    ...
    $("#btnSearch").click(function () { return frmDailySummary.valid(); });
...
function jsfn_ShowData() {
    ...
    $("#btnDownload").attr("href", "/Report/DownloadDailySummary?reportdate=" + $("#txtReportDate").val() + "&referenceid=" + $("#cboReference").val());
...
function jsfn_bindTable() {
    ...
    jsfn_ConvertToDatableWithCustomSort($('#tblDailySummaryReport'), vColumnsList, 'No Record Found', vSortOrder);
    $(".collapse").click();
}