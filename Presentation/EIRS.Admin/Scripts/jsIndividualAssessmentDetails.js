...
function jsfn_onAssetTypeChange() {
    ...
    jsfn_ajaxPost('/Individual/GetTaxPayerAssetList', vData, jsfn_onAssetTypeChangeResponse);
...
function jsfn_onAssetChange() {
    ...
    jsfn_ajaxPost('/Individual/GetProfileList', vData, jsfn_onAssetChangeResponse);
...
function jsfn_onProfileChange() {
    ...
    jsfn_ajaxPost('/Individual/GetAssessmentRuleList', vData, jsfn_onProfileChangeResponse);
...
function jsfn_onAssessmentRuleChange() {
    ...
    if (vAssessmentRuleID != '') {
        ...
        jsfn_ajaxPost('/Individual/GetAssessmentRuleItemList', vData, jsfn_onAssessmentRuleChangeResponse);
    }
    else {
        $("#lblTaxYear").html('');
...
function jsfn_ShowAssessmentItemDetails(AssessmentItemID) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/Individual/GetAssessmentItemDetails', vData, jsfn_ShowAssessmentItemDetailResponse)
}
...
function jsfn_UpdateTaxAmount() {
    if ($('#frmAssessmentItem').valid()) {
        ...
        jsfn_ShowLoading();
        jsfn_ajaxPost('/Individual/UpdateAssessmentItem', vData, jsfn_UpdateTaxAmountResponse);
    }
}
