var vBillDetailsAgingByTaxOfficeDataTable;
$(document).ready(function () {
    vBillDetailsAgingByTaxOfficeDataTable = $("#tblBillDetailsAgingByTaxOffice").DataTable({
        "processing": true, // for show progress bar
        "serverSide": true, // for process server side
        "filter": true,
        "orderMulti": false, // for disable multiple column at once
        "ajax": {
            "url": "/OperationManager/BillAgingDetailsByTaxOfficeLoadData",
            "type": "POST",
            "datatype": "json",
            "data": function (data) {
