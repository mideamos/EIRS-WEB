...
function jsfn_bindTable() {
    vTaxPayerLiabilityStatusDataTable = $("#tblPayeRevenueStreamBillDetailByTaxOffice").DataTable({
        "processing": true, // for show progress bar
        "serverSide": true, // for process server side
        "filter": true,
        "orderMulti": false, // for disable multiple column at once
        "ajax": {
            "url": "/OperationManager/PayeRevenueStreamBillDetailByTaxOfficeLoadData",
            "type": "POST",
            "datatype": "json",
            "data": function (data) {
        ...
        "columns": [
            ...
            { "data": "TaxPayerRINNumber", "orderable": true, "name": "TaxPayerRINNumber", "width": "25%" },
            { "data": "TaxPayerTIN", "orderable": true, "name": "TaxPayerTIN", "width": "25%" },
