        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function (data, type, st) {
                    ...
                    if (jQuery.inArray(st.PDMPID.toString(), vArrEntry) !== -1) {
                        return '<input type="checkbox" name="chkEntry" checked="checked" class="icheck" data-checkbox="icheckbox_square-green" id="chkSelect_' + st["PDMPID"] + '" data-eid="' + st["PDMPID"] + '">';
                    }
                    else {
                        return '<input type="checkbox" name="chkEntry" class="icheck" data-checkbox="icheckbox_square-green" id="chkSelect_' + st["PDMPID"] + '" data-eid="' + st["PDMPID"] + '">';
