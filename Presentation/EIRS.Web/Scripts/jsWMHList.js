    ...
    $('#tblWMH').DataTable({
        ...
        "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
            $('td:eq(4)', nRow).html('<div class="btn-group"><button type = "button" class= "btn btn-theme dropdown-toggle md-skip btn-xs" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action<span class="caret"></span>'
                ...
                + 'Quick View</a></li><li><a href="/Profile/WMH_TaxPayer?id=' + aData["ProfileID"] + '&name=' + toSeoUrl(aData["ProfileDescription"]) + '">Tax Payer List</a></li><li><a href="/Profile/WMH_Asset?id=' + aData["ProfileID"] + '&name=' + toSeoUrl(aData["ProfileDescription"]) + '">Asset List</a></li></ul></div>');
        },
    });
