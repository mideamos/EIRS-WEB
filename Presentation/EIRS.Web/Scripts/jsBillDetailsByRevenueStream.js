...
var vBillDetailsByRevenueStreamDataTable;
function jsfn_bindTable() {
    vBillDetailsByRevenueStreamDataTable = $("#tblBillDetailsByRevenueStream").DataTable({
        "processing": true, // for show progress bar
        "serverSide": true, // for process server side
        "filter": true,
        "orderMulti": false, // for disable multiple column at once
        "ajax": {
            "url": "/OperationManager/BillByRevenueStreamDetailLoadData",
            "type": "POST",
            "datatype": "json",
            "data": function (data) {
                ...
                data.BillTypeID = $("#hdnBillType").val();
                data.BillStatusID = $("#hdnBillStatus").val();
