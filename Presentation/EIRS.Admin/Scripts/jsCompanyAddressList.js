    ...
    $('#dvRemoveDialog').dialog({
        ...
        buttons: [{
            ...
            click: function () {
                var vData = {
                    CAIID: $("#hdnTBID").val(),
                    CompanyID: $("#hdnOtherID").val()
                };

                jsfn_ShowLoading();
                jsfn_ajaxPost('/Company/RemoveAddressInformation', vData, jsfn_RemoveAddressResponse);
            }
        }, {
...
function jsfn_ShowDetails(bldid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/Company/GetAddressInformationDetails', vData, jsfn_AddressDetailResponse);
}
