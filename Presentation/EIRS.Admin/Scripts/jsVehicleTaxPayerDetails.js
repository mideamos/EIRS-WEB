$(document).ready(function () {
    ...
    $("#btnBack").click(function () {
        ...
        $("#btnSave").hide();
        $("#btnBack").hide();
        $("#artVehicleTaxPayer").addClass("col-lg-6");
        return false;
    });
...
function jsfn_onTaxPayerTypeChange() {
    ...
    jsfn_ajaxPost('/Vehicle/GetTaxPayerRole_ATTP', vData, jsfn_onTaxPayerTypeChangeResponse);
}
...
function jsfn_BindTaxPayerTable() {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/Vehicle/GetTaxPayerList', vData, jsfn_BindTaxPayerTableResponse);
}
