    ...
    $('#dvRemoveDialog').dialog({
        ...
        buttons: [{
            ...
            click: function () {
                ...
                jsfn_ShowLoading();
                jsfn_ajaxPost('/Individual/RemoveAsset', vData, jsfn_RemoveLinkResponse);
            }
        }, {
...
function jsfn_ChangeStatus(tpaid, taxpayerid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/Individual/UpdateAssetStatus', vData, jsfn_ChangeStatusResponse);
}
...
function jsfn_ShowDetails(tpaid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/Individual/GetAssetDetails', vData, jsfn_AssetDetailResponse);
}
