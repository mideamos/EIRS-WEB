$(document).ready(function () {
    ...
    $("#btnSaveBuildingUnit").click(function () {
        if (vfrmBuildingUnit.valid()) {
            ...
            jsfn_ShowLoading();
            jsfn_ajaxPost('/CaptureSpecial/AddBuildingUnit', vData, jsfn_onAddBuildingResponse);
        }
    });
...
function jsfn_onTownChange() {
    ...
    if (vTownID != '') {
        ...
        jsfn_ajaxPost('/CaptureSpecial/GetTownDetails', vData, jsfn_onTownChangeResponse);
    }
}
...
function jsfn_onLGAChange() {
    ...
    jsfn_ajaxPost('/CaptureSpecial/GetWard', vData, jsfn_onLGAChangeResponse);
}
...
function jsfn_onUnitPurposeChange() {
    ...
    jsfn_ajaxPost('/CaptureSpecial/GetUnitFunction', vData, jsfn_onUnitPurposeChangeResponse);
}
