$(document).ready(function () {
    ...
    $("#btnBack").click(function () {
        ...
        $("#btnSave").hide();
        $("#btnBack").hide();
        $("#artBuildingTaxPayer").addClass("col-lg-6");
        return false;
    });
...
function jsfn_onTaxPayerTypeChange() {
    ...
    jsfn_ajaxPost('/Building/GetTaxPayerRole_ATTP', vData, jsfn_onTaxPayerTypeChangeResponse);
}
...
function jsfn_BindTaxPayerTable() {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/Building/GetTaxPayerList', vData, jsfn_BindTaxPayerTableResponse);
}
