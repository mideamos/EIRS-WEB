...
//        console.log(Result);
    ...
    updateChart: function()
    {
        if (this.chart != null)
        {
            ...
            this.chartType = document.getElementById("pie-chart-type-4").value;
            
            this.defaultChart = vehicleListResult;
    ...
    compareBy: function(Result)
    {
        ...
        else if (this.chartType == "sub_type")
            return Result.VehicleSubTypeName;
        else if (this.chartType == "purpose")
            return Result.VehiclePurposeName;
        else if (this.chartType == "function")
            return Result.VehicleFunctionName;
        else if (this.chartType == "ownership")
            return Result.VehicleOwnershipName;
    }
};