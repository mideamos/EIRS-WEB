...
$(document).ready(function () {
    ...
    vTable = $("#tblData").DataTable({
        ...
        "ajax": {
            "url": "/EMPDMainAuthorized/LoadData",
            "type": "POST",
            "datatype": "json",
        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function (data, type, st) {
                    ...
                    if (jQuery.inArray(st.PDMAID.toString(), vArrEntry) !== -1) {
                        return '<input type="checkbox" name="chkEntry" checked="checked" class="icheck" data-checkbox="icheckbox_square-green" id="chkSelect_' + st["PDMAID"] + '" data-eid="' + st["PDMAID"] + '">';
                    }
                    else {
                        return '<input type="checkbox" name="chkEntry" class="icheck" data-checkbox="icheckbox_square-green" id="chkSelect_' + st["PDMAID"] + '" data-eid="' + st["PDMAID"] + '">';
