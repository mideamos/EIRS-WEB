...
var vPaymentByRevenueStreamDetailTable;

jQuery(document).ready(function () {
    vPaymentByRevenueStreamDetailTable = $("#tblPaymentDetailsByRevenueStream").DataTable({
        ...
        "ajax": {
            "url": "/OperationManager/PaymentByRevenueStreamDetailLoadData",
            "type": "POST",
            "datatype": "json",
            "data": function (data) {
