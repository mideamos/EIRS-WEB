    ...
    $('#dvRemoveDialog').dialog({
        ...
        buttons: [{
            ...
            click: function () {
                ...
                jsfn_ShowLoading();
                jsfn_ajaxPost('/Building/RemoveTaxPayer', vData, jsfn_RemoveLinkResponse);
            }
        }, {
...
function jsfn_ChangeStatus(tpaid, assetid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/Building/UpdateTaxPayerStatus', vData, jsfn_ChangeStatusResponse);
}
...
function jsfn_ShowDetails(tpaid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/Building/GetTaxPayerDetails', vData, jsfn_TaxPayerDetailResponse);
}
