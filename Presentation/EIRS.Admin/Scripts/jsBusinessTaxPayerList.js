    ...
    $('#dvRemoveDialog').dialog({
        ...
        buttons: [{
            ...
            click: function () {
                ...
                jsfn_ShowLoading();
                jsfn_ajaxPost('/Business/RemoveTaxPayer', vData, jsfn_RemoveLinkResponse);
            }
        }, {
...
function jsfn_ChangeStatus(tpaid, assetid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/Business/UpdateTaxPayerStatus', vData, jsfn_ChangeStatusResponse);
}
...
function jsfn_ShowDetails(tpaid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/Business/GetTaxPayerDetails', vData, jsfn_TaxPayerDetailResponse);
}
