$(document).ready(function () {
    ...
    var vFromTaxPayer = new Bloodhound({
        ...
        remote: {
            ...
            replace: function (url, uriEncodedQuery) {
                var vRequestUrl = (url + "?TaxPayerTypeID=" + $("#cboFromTaxPayerType").val() + "&query="
    ...
    var vFromTaxPayerSelectedHandler = function (eventObject, suggestionObject, suggestionDataset) {
    ...
    var vToTaxPayer = new Bloodhound({
        ...
        remote: {
            url: '/Base/GetTaxPayer',
            replace: function (url, uriEncodedQuery) {
                var vRequestUrl = (url + "?TaxPayerTypeID=" + $("#cboToTaxPayerType").val() + "&query="
                    + encodeURIComponent(uriEncodedQuery));
                return vRequestUrl;
            },
            filter: function (list) {
    ...
    var vToTaxPayerSelectedHandler = function (eventObject, suggestionObject, suggestionDataset) {
        ...
        jsfn_ajaxPost('/OperationManager/GetBalance/', vData, jsfn_onGetToBalanceResponse);
...
function jsfn_GetBalanceForFromTaxPayer() {
    ...
    jsfn_ajaxPost('/OperationManager/GetBalance/', vData, jsfn_onGetFromBalanceResponse);
}
