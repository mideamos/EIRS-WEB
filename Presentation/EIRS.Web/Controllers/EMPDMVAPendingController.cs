...
{
    public class EMPDMVAPendingController : BaseController
    {
        // GET: EMPDMVAPending
        [HttpGet]
        ...
        public ActionResult ImportData(EMDataImportViewModel pObjDataImportModel)
        {
            ...
            else
            {
                if (pObjDataImportModel.ExcelFile.ContentLength > 0)
                {
                    ...
                    {
                        string strInputFileName = "PDMVAPendingData_" + DateTime.Now.ToString("dd_MM_yyyy") + "_" + DateTime.Now.Hour + "_" + DateTime.Now.Minute + "_" + DateTime.Now.Second + "." + strUploadedFileExt;
                        string strOutputFileName = "PDMVAPendingResult_" + DateTime.Now.ToString("dd_MM_yyyy") + "_" + DateTime.Now.Hour + "_" + DateTime.Now.Minute + "_" + DateTime.Now.Second + "." + strUploadedFileExt;
                        string fileLocation = GlobalDefaultValues.DocumentLocation + "ERASManual/PDMVAP/";
                        ...
                        using (ExcelPackage mObjExcelPackage = new ExcelPackage(new FileInfo(fileLocation + "/" + strInputFileName)))
                        {
                            if (mObjExcelPackage.Workbook.Worksheets.Count == 1)
                            {
                                ...
                                if (dtExcelData.Rows.Count > 0)
                                {
                                    ...
                                    EM_PD_MVA_Pending mObjMVAPending;
                                    ...
                                    foreach (DataRow drData in dtExcelData.Rows)
                                    {
                                        try
                                        {
                                            ...
                                            mObjMVAPending = new EM_PD_MVA_Pending()
                                            {
                                                PDMVPID = 0,
                                            ...
                                            mObjFuncResponse = mObjBLEMDataImport.BL_InsertPDMVAPending(mObjMVAPending);
                                    ...
                                    EM_ImportLog mObjImportLog = new EM_ImportLog()
                                    {
                                        ...
                                        ImportFilePath = "ERASManual/PDMVAP/" + strInputFileName,
                        ...
                        {
                            ExcelWorksheet ObjExcelWorksheet = mObjExcelPackage.Workbook.Worksheets.Add("PDMVAPending");
                            ...
                            ViewBag.ResultFilePath = "/Document/ERASManual/PDMVAP/" + strOutputFileName;
                            return View();
        ...
        public ActionResult AddEntry(EMPDViewModel pObjEMPDModel)
        {
            ...
            else
            {
                try
                {
                    EM_PD_MVA_Pending mObjMVAPending = new EM_PD_MVA_Pending()
                    {
                        PDMVPID = 0,
                    ...
                    FuncResponse mObjFuncResponse = new BLEMDataImport().BL_InsertPDMVAPending(mObjMVAPending);
        ...
        public JsonResult LoadData()
        {
            ...
            try
            {
                ...
                // Loading. 
                IList<vw_EM_PD_MVA_Pending> lstData = new BLEMDataImport().BL_GetPDMVAPendingList();
        ...
        public ActionResult Details(long? id)
        {
            ...
            {
                EM_PD_MVA_Pending mObjDetails = new BLEMDataImport().BL_GetPDMVAPendingDetails(id.GetValueOrDefault());
                ...
                {
                    return RedirectToAction("List", "EMPDMVAPending");
                }
            }
            else
            {
