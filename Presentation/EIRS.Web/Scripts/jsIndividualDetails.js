...
$(document).ready(function () {
    ...
    jsfn_ConvertToDatableWithCustomSort($('#tblPendingList'), [{ "orderable": true }, { "orderable": true }, { "orderable": true }, { "orderable": true }, { "orderable": true }, { "orderable": true }, { "orderable": false }], 'No Assoicated Pending Approvals Found');
    jsfn_ConvertToDatableWithCustomSort($('#tblDendingList'), [{ "orderable": true }, { "orderable": true }, { "orderable": true }, { "orderable": true }, { "orderable": true }, { "orderable": true }, { "orderable": false }], 'No Assoicated Declined Approvals Found');
