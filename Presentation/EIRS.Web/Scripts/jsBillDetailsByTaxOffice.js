...
var vBillDetailsByTaxOfficeDataTable;
function jsfn_bindTable() {
    vBillDetailsByTaxOfficeDataTable = $("#tblBillDetailsByTaxOffice").DataTable({
        "processing": true, // for show progress bar
        "serverSide": true, // for process server side
        "filter": true,
        "orderMulti": false, // for disable multiple column at once
        "ajax": {
            "url": "/OperationManager/BillByTaxOfficeDetailLoadData",
            "type": "POST",
            "datatype": "json",
            "data": function (data) {
