...
function jsfn_DisplayDataResponse(data) {
    if (data.success == true) {
        ...
        $('#txtGovernmentName').html($('#GovernmentName').val());
        $('#txtTIN').html($('#TIN').val());
        $('#txtGovernmentType').html($('#GovernmentTypeID option:selected').text());
        $('#txtTaxOffice').html($('#TaxOfficeID option:selected').text());
        $('#txtPayerType').html("Government");
        $('#txtContactName').html($('#ContactName').val());
        $('#txtEmail').html($('#ContactEmail').val());
        $('#txtNumber').html($('#ContactNumber').val());
        $('#txtNotficationMethod').html($('#NotificationMethodID option:selected').text());
        $('#txtContactAdddress').html($('#ContactAddress').val());
    }
    else {
