    ...
    $('#dvRemoveDialog').dialog({
        ...
        buttons: [{
            ...
            click: function () {
                ...
                jsfn_ShowLoading();
                jsfn_ajaxPost('/Special/RemoveAsset', vData, jsfn_RemoveLinkResponse);
            }
        }, {
...
function jsfn_ChangeStatus(tpaid, taxpayerid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/Special/UpdateAssetStatus', vData, jsfn_ChangeStatusResponse);
}
...
function jsfn_ShowDetails(tpaid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/Special/GetAssetDetails', vData, jsfn_AssetDetailResponse);
}
