////QC_VP_T-ERAS-152,153,154_GetPaymentByTaxOffice_01
jQuery(document).ready(function () {
    jsfn_bindTable();
});

var vPaymentDetailsByTaxOfficeDataTable;
function jsfn_bindTable() {
    vPaymentDetailsByTaxOfficeDataTable = $("#tblPaymentDetailsByTaxOffice").DataTable({
        ...
        "ajax": {
            "url": "/OperationManager/PaymentDetailByTaxOfficeLoadData",
            "type": "POST",
            "datatype": "json",
            "data": function (data) {
                data.FromDate = $("#hdnFromDate").val();
                data.ToDate = $("#hdnToDate").val();
                data.intPaymentTypeID = $("#hdnPaymentType").val();
                data.intTaxOfficeID = $("#hdnTaxOffice").val();
        ...
        "columns": [
            ...
            { "data": "PaymentRef", "orderable": true, "name": "PaymentRef", "width": "25%" },
            {
            ...
            { "data": "PaymentMethodName", "orderable": true, "name": "PaymentMethodName", "width": "25%" },
            {
