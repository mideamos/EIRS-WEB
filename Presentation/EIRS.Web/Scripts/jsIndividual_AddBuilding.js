$(document).ready(function () {
    ...
    $("#btnSaveBuildingUnit").click(function () {
        if (vfrmBuildingUnit.valid()) {
            ...
            jsfn_ShowLoading();
            jsfn_ajaxPost('/CaptureIndividual/AddBuildingUnit', vData, jsfn_onAddBuildingResponse);
        }
    });
...
function jsfn_onTownChange() {
    ...
    if (vTownID != '') {
        ...
        jsfn_ajaxPost('/CaptureIndividual/GetTownDetails', vData, jsfn_onTownChangeResponse);
    }
}
...
function jsfn_onLGAChange() {
    ...
    jsfn_ajaxPost('/CaptureIndividual/GetWard', vData, jsfn_onLGAChangeResponse);
}
...
function jsfn_onUnitPurposeChange() {
    ...
    jsfn_ajaxPost('/CaptureIndividual/GetUnitFunction', vData, jsfn_onUnitPurposeChangeResponse);
}
