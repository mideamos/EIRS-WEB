...
//        console.log(Result);
        ...
        for (var a = 0; a < Result.length; a++)
        {
            if (Result[a].Active && (this.taxPayerType == Result[a].TaxPayerTypeName || this.taxPayerType == "all"))
            {
                ...
                for (var b = 0; b < Result.length; b++)
                {
                    ...
                    {
                        totalServiceBillAmount += this.getAmount(Result[b]);
                    }
                }
    ...
    updateChart: function(newValue, btn)
    {
        if (this.lineChart != null)
        {
            ...
            this.billType = document.getElementById("bill-type-2").value;
            this.taxPayerType = document.getElementById("tax-payer-type-2").value;
        ...
        var buttons = document.getElementById("chart-2").getElementsByTagName("button");
