$(document).ready(function () {
    ...
    var vfrmTaxOfficerStatus = $("#frmTaxOfficerStatus");
    vfrmTaxOfficerStatus.validate({
    ...
    $("#btnExportToExcel").click(function () {
        ...
        var vUrl = '/OperationManager/TaxOfficerStatusExportToExcel?TaxOfficeID=' + vTaxOfficeID + '&TaxPayerTypeID=' + vTaxPayerTypeID + '&ReviewStatusID=' + vReviewStatusID + '&TaxOfficerID=' + vTaxOfficerID;
...
function jsfn_bindTable() {
    if (vTaxPayerTable !== undefined) {
        ...
        vTaxPayerTable = $("#tblTaxPayer").DataTable({
            ...
            "ajax": {
                "url": "/OperationManager/TaxOfficerStatusLoadData",
                "type": "POST",
                "datatype": "json",
                "data": function (data) {
