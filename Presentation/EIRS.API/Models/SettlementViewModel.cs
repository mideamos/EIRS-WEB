...
{
    public partial class SettlementModel : SettlementViewModel
    {
        [Required(AllowEmptyStrings = false, ErrorMessage = "Please Enter Transaction Ref No")]
        public string TransactionRefNo { get; set; }

        public IList<Settlement_ASBItem> lstSettlementItems { get; set; }
