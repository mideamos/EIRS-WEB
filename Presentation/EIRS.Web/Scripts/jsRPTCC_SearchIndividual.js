$(document).ready(function () {
    ...
    $("#btnModalContinue").click(function () {
        ...
        jsfn_ajaxPost('/RequestPersonalTCC/SetSelectedIndividual', vData, jsfn_ModalContinueResponse);
    });
    ...
    $("#btnAddNewIndividual").click(function () {
        if ($("#txtAddIndividual_MobileNumber").val() != '') {
            ...
            jsfn_ajaxPost('/RequestPersonalTCC/CheckMobileNumber', vData, jsfn_ModalContinueResponse);
        }
        else {
...
function jsfn_SelectIndividual(IndID) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/RequestPersonalTCC/GetIndividualDetails', vData, jsfn_IndividualDetailResponse);
}
