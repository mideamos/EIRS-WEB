...
function jsfn_BindBillChartResponse(data) {
    ...
    if (vBillTypeID === '1' || vBillTypeID === '2') {
        vchrtBillContainer.options.data[0].showInLegend = false
    }
...
function jsfn_BindTaxPayerBillChartResponse(data) {
    ...
    if (vBillTypeID === '1' || vBillTypeID === '2') {
        vchrtTaxPayerBillContainer.options.data[0].showInLegend = false
    }
...
function jsfn_BindTaxPayerSettlementChartResponse(data) {
    ...
    if (vBillTypeID === '1' || vBillTypeID === '2') {
        vchrtTaxPayerSettlementContainer.options.data[0].showInLegend = false
    }
...
function jsfn_BindBillAgingChartResponse(data) {
    ...
    if (vBillTypeID === '1' || vBillTypeID === '2') {
        vchrtBillAging.options.data[0].showInLegend = false
    }
