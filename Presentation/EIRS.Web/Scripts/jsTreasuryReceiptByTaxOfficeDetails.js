...
var vTreasuryReceiptByTaxOfficeDetailTable;

jQuery(document).ready(function () {
    vTreasuryReceiptByTaxOfficeDetailTable = $("#tblTreasuryReceiptDetailsByTaxOffice").DataTable({
        ...
        "ajax": {
            "url": "/OperationManager/TreasuryReceiptByTaxOfficeDetailLoadData",
            "type": "POST",
            "datatype": "json",
            "data": function (data) {
