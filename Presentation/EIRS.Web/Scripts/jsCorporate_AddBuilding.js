$(document).ready(function () {
    ...
    $("#btnSaveBuildingUnit").click(function () {
        if (vfrmBuildingUnit.valid()) {
            ...
            jsfn_ShowLoading();
            jsfn_ajaxPost('/CaptureCorporate/AddBuildingUnit', vData, jsfn_onAddBuildingResponse);
        }
    });
...
function jsfn_onTownChange() {
    ...
    if (vTownID != '') {
        ...
        jsfn_ajaxPost('/CaptureCorporate/GetTownDetails', vData, jsfn_onTownChangeResponse);
    }
}
...
function jsfn_onLGAChange() {
    ...
    jsfn_ajaxPost('/CaptureCorporate/GetWard', vData, jsfn_onLGAChangeResponse);
}
...
function jsfn_onUnitPurposeChange() {
    ...
    jsfn_ajaxPost('/CaptureCorporate/GetUnitFunction', vData, jsfn_onUnitPurposeChangeResponse);
}
