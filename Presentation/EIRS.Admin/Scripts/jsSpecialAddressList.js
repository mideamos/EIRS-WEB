    ...
    $('#dvRemoveDialog').dialog({
        ...
        buttons: [{
            ...
            click: function () {
                var vData = {
                    SAIID: $("#hdnTBID").val(),
                    SpecialID: $("#hdnOtherID").val()
                };

                jsfn_ShowLoading();
                jsfn_ajaxPost('/Special/RemoveAddressInformation', vData, jsfn_RemoveAddressResponse);
            }
        }, {
...
function jsfn_ShowDetails(bldid) {
    ...
    jsfn_ShowLoading();
    jsfn_ajaxPost('/Special/GetAddressInformationDetails', vData, jsfn_AddressDetailResponse);
}
